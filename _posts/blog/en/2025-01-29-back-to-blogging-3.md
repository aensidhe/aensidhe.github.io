---
layout: post
title: Who's there, again?
excerpt: Why you should have a backup new phone.
categories: blog
comments: true
lang: en
...
So, since my last [post]({% post_url blog/2022-06-29-raidz2 %}), I quit Ozon after working there for a year and a half and joined Picodata as a lead developer. Though, almost immediately, they made me a team lead, and that’s what I’ve been doing ever since. Over the past year and a half, we’ve built several plugins for Picodata, like Radix—a Redis implementation on top of Picodata.
...
Oh, and I started a [Telegram channel](https://t.me/aensidhe_blog) for cross-posts going forward. It'll be in russian but with Deepseek and friends it shouldn't be any problem at all.
