...
excerpt: Можно ли использовать Tarantool в .Net приложениях и как мы докатились до жизни такой? Какие проблемы бывают при написании своих коннекторов? Проблемы, с которыми мы столкнулись в ходе эксплуатации Tarantool.
categories: blog
lang: ru
tags:
  - tarantool
